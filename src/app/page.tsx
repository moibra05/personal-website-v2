      ...
      <PageSection>
        <div className="flex flex-col w-fit h-screen justify-center mx-auto">
          ...
          <h1 className="flex flex-col leading-snug">
            <span className="text-2xl">Hello,</span> I&apos;m Mohamed
          </h1>
          <h2>Software Engineer | Web Developer | Problem Solver</h2>
          <div className="flex justify-center gap-4 mt-2">
            <Link
              className="b text-white border-[3px] rounded-full p-1 group hover:cursor-pointer hover:border-secondary transition-colors duration-300"
              href="https://github.com/moibra05"
              target="_blank"
            >
              <FontAwesomeIcon
                icon={faGithub}
                className="w-6 h-6 fa-fw text-white group-hover:text-secondary transition-colors duration-300"
              />
            </Link>
            <Link
              className="b text-white border-[3px] rounded-full p-1 group hover:cursor-pointer hover:border-secondary transition-colors duration-300"
